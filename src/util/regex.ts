 ...
 * synthesized checkpoint depends on this function, so it gets one definition.
 *
 * Deliberately not imported by `surface/web/perceive.ts`: that module is serialized
